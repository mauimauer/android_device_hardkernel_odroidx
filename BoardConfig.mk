# BoardConfig for ODROID-X

TARGET_BOARD_PLATFORM := exynos4
TARGET_SOC := exynos4x12

#TARGET_PREBUILT_KERNEL := device/hardkernel/odroidx/kernel
...
TARGET_KERNEL_CONFIG := odroidx_android_sdmmc_defconfig
TARGET_KERNEL_SOURCE := kernel/hardkernel/4412-common

COMMON_GLOBAL_CFLAGS += -DEXYNOS4_ENHANCEMENTS

BOARD_CUSTOM_BOOTIMG_MK := device/hardkernel/odroidx/uboot-bootimg.mk

BOARD_USES_SAMSUNG_HDMI := true

TARGET_SPECIFIC_HEADER_PATH := device/hardkernel/odroidx/include
...
BOARD_CUSTOM_GRAPHICS := ../../../device/hardkernel/odroidx/recovery/graphics.c

TARGET_USERIMAGES_SPARSE_EXT_DISABLED := true
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/hardkernel/odroidx/releasetools/odroid_ota_from_target_files